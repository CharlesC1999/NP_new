...
const Class = () => {
  ...
  <main
        ...
        <main className={`${ClassStyles.ProductBorder} ${ClassStyles.main} ${ClassStyles.desk}`}>
          ...
          <div className="row" key={element.id}>
            ...
            >
              ...
              <span onClick={()=>{
               ...
               <span onClick={()=>{increase(element.id)}} className="plus">+</span>
              {/* </div> */}
            </div>
            <div className="col align-self-center text-center">{element.price}</div>
            <div className="col align-self-center text-center">{element.price * element.count}</div>
            <div
              className="col d-flex align-items-center justify-content-center"
              style={{ height: 160 }}
            >
              <img src="/images/Delete.jpg" alt="" onClick={()=>{
  ...
  {/* 手機樣式 */}
  <main className={`${ClassStyles.main} ${ClassStyles.ProductBorder} ${ClassStyles.mobile} mt-5`}>
    ...
    <div className="row" key={element.id}>
      ...
      <div className="col-8 pb-3 pt-2">
        ...
        <div className="row mt-1">
          ...
          <span className="col-5 pt-1" style={{ marginLeft: "-25px", fontSize: "14px" }}>
            2024/04/05
          </span>
        </div>
        <div className="row mt-1">
          <div className="col d-flex flex-column align-items-center justify-content-between">
            <span className={`${ClassStyles.mobileFc} text-center`}> 人數 </span>
          ...
          <div className="col d-flex flex-column align-items-center justify-content-between">
            <span className={`${ClassStyles.mobileFc} text-center`}> 價格 </span>
            <span className={ClassStyles.fb}>{element.count * element.price}</span>
          </div>
        </div>
      </div>
    </div>
...
<div className="row" style={{ border: "1px solid #d9d9d9" }}>
  <div className="col py-2">
    <div className={`${ClassStyles.fb} row ps-3 pb-2`}> 折價券代碼、折價券 : </div>
    <div className="row">
      {/* 使用折價券 */}
      <div className="pay d-flex justify-content" style={{ width: "100%" }}>
        ...
        <select className="form-select form-select-sm me-5" aria-label="Small select example " style={{ width: 100 }}>
...
<div className="row py-2" style={{ border: "1px solid #d9d9d9", borderTop: 0 }}>
  <div className={`${ClassStyles.fb} col`}>課程結帳金額 :</div>
  <div className={`${ClassStyles.fc} col`} style={{ marginLeft: "-100px" }}>
    {/* 计算总价 */}
    ${classData.reduce((total, product) => total + product.count * product.price, 0)}
  </div>
</div>
