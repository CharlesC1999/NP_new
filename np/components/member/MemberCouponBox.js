  ...
  const handleCouponRedeem = async (couponId) => {
    try {
      ...
      setCoupons((prevCoupons) =>
        prevCoupons.filter((coupon) => coupon.coupon__i_d !== couponId)
      );
      // alert('領取成功^^');
    } catch (error) {
                    ...
                    <div className={styles.couponCard} key={v.coupon__i_d}>
                      ...
                      <div className={styles.couponContent}>
                        ...
                        <div className={styles.couponButton}>
                          {isButtonDisabled ? (
                            <button
                              className={`${styles.couponBtn} btn`}
                              onClick={() => handleCouponRedeem(v.coupon__i_d)}
                            >
                              領取
                            </button>
                          ) : (
