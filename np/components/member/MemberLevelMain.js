            ...
            <div className={styles.membershipDetails}>
              ...
              <div className="d-flex">
                <div className={styles.levelLeft}>
                  ...
                  <div className={styles.upgradeAmountInfo}>
                    升級所需金額:
                    <h3>{needmoney}</h3>
                  </div>
                </div>
                <div className={styles.levelRight}>
                  <img
                    src={`/images/level/lv${nowlevel}.png`}
                    alt={`Level ${nowlevel}`}
                  />
                </div>
              </div>
