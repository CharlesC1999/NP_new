      ...
      <div className={`${styles2.frame} container`}>
        <form action="" method="POST">
          ...
          儲存這個號碼 */}
                ...
                <div className="input-group mb-3" style={{}}>
                  <button
                    className={`${styles2.button} btn btn-outline-secondary dropdown-toggle py-1`}
                    type="button"
                    data-bs-toggle="dropdown"
                    aria-expanded="false"
                  >
          ...
          >
            <div
              className="pay1 d-flex flex-column  align-items-center pt-3 "
